...
export function DeleteIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      ...
      width={height}
    >
      <path fill={fill} d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z" />
    </svg>
  );
}
...
export function FilterIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      ...
      width={width}
    >
      <path fill={fill} d="M411.155-260.001V-320h137.306v59.999H411.155Zm-155-190v-59.998H703.46v59.998H256.155ZM140.001-640v-59.999h679.998V-640H140.001Z" />
    </svg>
  );
}
