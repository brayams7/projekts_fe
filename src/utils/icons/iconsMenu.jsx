...
export function CalendarIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
      ...
      width={width}
    >
      <path fill={fill} d="M438-255.231 323.692-369.538l28.77-28.77L438-312.769l169.538-169.539 28.77 28.77L438-255.231ZM224.615-120Q197-120 178.5-138.5 160-157 160-184.615v-510.77Q160-723 178.5-741.5 197-760 224.615-760h70.769v-89.231h43.077V-760h286.154v-89.231h40.001V-760h70.769Q763-760 781.5-741.5 800-723 800-695.385v510.77Q800-157 781.5-138.5 763-120 735.385-120h-510.77Zm0-40h510.77q9.23 0 16.923-7.692Q760-175.385 760-184.615v-350.77H200v350.77q0 9.23 7.692 16.923Q215.385-160 224.615-160ZM200-575.385h560v-120q0-9.23-7.692-16.923Q744.615-720 735.385-720h-510.77q-9.23 0-16.923 7.692Q200-704.615 200-695.385v120Zm0 0V-720v144.615Z" />
    </svg>
  );
}

export function CalendarStartAtIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function DoneIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      ...
      width={width}
    >
      <path fill={fill} d="m382-267.692-198.769-198.77L211.769-495 382-324.769 748.231-691l28.538 28.538L382-267.692Z" />
    </svg>
  );
}

export function DownloadIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
