...
export function MoveToIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    ...
    >
      <path
        fill={fill}
        d="M224.615-160Q197-160 178.5-178.5 160-197 160-224.615v-124.616h40v124.616q0 9.23 7.692 16.923Q215.385-200 224.615-200h510.77q9.23 0 16.923-7.692Q760-215.385 760-224.615v-510.77q0-9.23-7.692-16.923Q744.615-760 735.385-760h-510.77q-9.23 0-16.923 7.692Q200-744.615 200-735.385v124.616h-40v-124.616Q160-763 178.5-781.5 197-800 224.615-800h510.77Q763-800 781.5-781.5 800-763 800-735.385v510.77Q800-197 781.5-178.5 763-160 735.385-160h-510.77Zm209.231-163.077-28.308-28.769L513.692-460H160v-40h353.692L405.538-608.154l28.308-28.769L590.769-480 433.846-323.077Z"
      />
    </svg>
  );
}
...
export function CalendarStartAtIcon({
  ...
  return (
    ...
    >
      <path
        fill={fill}
        d="M200-575.385h560v-120q0-9.23-7.692-16.923Q744.615-720 735.385-720h-510.77q-9.23 0-16.923 7.692Q200-704.615 200-695.385v120Zm0 0V-720v144.615ZM224.615-120Q197-120 178.5-138.5 160-157 160-184.615v-510.77Q160-723 178.5-741.5 197-760 224.615-760h70.769v-89.231h43.077V-760h286.154v-89.231h40.001V-760h70.769Q763-760 781.5-741.5 800-723 800-695.385v210.077q-9.769-3.615-19.769-5.384-10-1.77-20.231-3.231v-41.462H200v350.77q0 9.23 7.692 16.923Q215.385-160 224.615-160h268.154q3.154 11.231 8.038 20.846Q505.692-129.538 511-120H224.615Zm510.77 40q-66.847 0-113.424-46.577Q575.384-173.154 575.384-240t46.577-113.423Q668.538-400 735.385-400q66.846 0 113.423 46.577T895.385-240q0 66.846-46.577 113.423T735.385-80Zm66.23-71.923 21.846-21.846-72.692-72.693v-108.923H720v121.847l81.615 81.615Z"
      />
    </svg>
  );
}

export function EmailIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function DoneIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
    ...
    >
      <path
        fill={fill}
        d="m382-267.692-198.769-198.77L211.769-495 382-324.769 748.231-691l28.538 28.538L382-267.692Z"
      />
    </svg>
  );
}
...
export function AttachIcon({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
    ...
    >
      <path
        fill={fill}
        d="M460-89.23q-83.539 0-142.539-59.001-59-59-59-142.538v-444.616q0-60.288 42.933-103.221 42.933-42.932 103.221-42.932 60.289 0 103.222 42.932 42.932 42.933 42.932 103.221v400q0 38.123-26.329 64.447-26.329 26.323-64.462 26.323-38.132 0-64.44-26.323-26.307-26.324-26.307-64.447v-400h35.384v400q0 23.539 15.924 39.462Q436.462-280 460-280q23.538 0 39.461-15.923 15.924-15.923 15.924-39.462v-400q0-46.523-32.142-78.646t-78.693-32.123q-46.55 0-78.627 32.123t-32.077 78.646v444.616q0 69.077 48.539 117.615Q390.923-124.615 460-124.615t117.615-48.539q48.539-48.538 48.539-117.615v-444.616h35.385v444.616q0 83.538-59 142.538-59 59-142.539 59Z"
      />
    </svg>
  );
}
...
export function Person({ fill = FILL_COLOR, height = "24", width = "24" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function MoreTimeIcon({
  ...
  return (
    ...
    >
      <path
        fill={fill}
        d="M440.106-160q-66.645 0-124.896-24.88-58.252-24.881-101.83-68.422-43.577-43.541-68.479-101.744Q120-413.249 120-479.894t24.889-124.896q24.889-58.252 68.444-101.83 43.556-43.577 101.778-68.479Q373.333-800 440-800q21 0 40.5 2.5T520-790v42q-20-6-39.5-9t-40.5-3q-116.462 0-198.231 81.769Q160-596.462 160-480q0 116.462 81.769 198.231Q323.538-200 440-200q116.462 0 198.231-81.769Q720-363.538 720-480.131q0-10.869-1-22.177-1-11.307-3.769-22.307h40.462q2 9.461 3.153 21.538Q760-491 760-480q0 66.667-24.88 124.889-24.881 58.222-68.422 101.778-43.541 43.555-101.744 68.444Q506.751-160 440.106-160Zm125.74-165.846L420-471.692V-680h40v191.692l134.154 134.154-28.308 28.308ZM720-604.615v-120H600v-40.001h120v-120h40v120h120v40.001H760v120h-40Z"
      />
    </svg>
  );
}
