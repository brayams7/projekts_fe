...
const FloatingLinkEditor = ({editor}) => {
  ...
  return (
    <div className="editor-floating-link-container" ref={editorRef}>
      <div className="d-flex align-items-center editor-link-wrapper">
        <div className="flex-grow-1">
          {
            ...
            :
            <a
              className="d-block position-relative m-2 px-2 py-2 link"
              href={linkUrl}
