...
const StageCard = ({
  ...
  return (
    <React.Fragment>
      <div ref={setNodeRef} style={styles} className="card-stage-container">
        <div
          className="stage-card"
        ...
        >
          <div
            className={
              isDragging
                ? "stage-card-container-header d-flex justify-content-between mx-3 my-2 opacity-25"
          ...
          >
            ...
            >
              {!isEditTitleStage && (
                <>
                  <span>{titleStage}</span>{" "}
                  <span className="ms-3 px-2 border rounded-pill font_size_10_12">
                    {listFeatures.length}
                  </span>
                </>
              )}
          ...
          <div className="stage-card-list-features gap-3">
            <SortableContext items={listFeaturesId}>
