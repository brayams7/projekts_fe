    ...
    <div className="card card_custom card_login p-3">
      <div className="card-body">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {
            isError && (
              <p className="text-start text-danger font_size_10_12">{error}</p>
            )
          }
          <div className="mb-3">
            <input
            ...
            />
            {errors?.email && (
              <p className="invalid-feedback" style={{fontSize:"var(--size-12)"}}>{errors?.email?.message}</p>
            )}
          </div>
          ...
          <div className="mb-3">
            ...
            />
            {errors?.password && (
              <p className="invalid-feedback" style={{fontSize:"var(--size-12)"}}>{errors?.password?.message}</p>
            )}
          </div>

          <button className="btn_login mb-3" type="submit" disabled={loading}>
          {
