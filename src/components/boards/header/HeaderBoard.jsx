...
const HeaderBoard = ({
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: stylesBoard.header.backgroundColor,
        height: 50,
      }}
    >
      <div
      ...
      <ul className="nav nav-underline gap-4">
        {
          typesViewBoards.map(type=>(
            <li className="nav-item" key={type.id}>
              ...
              <a type="button" role="button" className={
                typeViewSelect === type.id ? "py-1 header-board-container-nav-item active" :
